...
component_system = CPSComponentSystem(
                    ...
                    specific_cake_resistances=[cake_resistance]*len(MWs) + [0],
                    )
...
fig_c.legend(lines + water_line, labels, loc='outside lower center', ncols=2, frameon=False)
fig_c.tight_layout()
